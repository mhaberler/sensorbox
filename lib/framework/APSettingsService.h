...
public:
    ...
    static StateUpdateResult update(JsonObject &root, APSettings &settings)
    {
        ...
        JsonUtils::readIP(root, "local_ip", newSettings.localIP, IPAddress((const uint8_t *)FACTORY_AP_LOCAL_IP));
        JsonUtils::readIP(root, "gateway_ip", newSettings.gatewayIP, IPAddress((const uint8_t *)FACTORY_AP_GATEWAY_IP));
        JsonUtils::readIP(root, "subnet_mask", newSettings.subnetMask, IPAddress((const uint8_t *)FACTORY_AP_SUBNET_MASK));
